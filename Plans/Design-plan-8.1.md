...
- **Skills/stats under 8.1.** The live game's 14 stats + trainers, and the previously planned skill web, are NOT assumed. Stats likely hang off gear + implants (cyborg), but this needs my ruling before any code work. *(2026-08-02: worthy of an entire ideation session — earmarked.)*
- **The multiplier chain.** PP stays the run engine; whether the live multiplier-chain structure survives as-is is undecided. *(2026-08-02: also worthy of an entire ideation session — earmarked.)*
