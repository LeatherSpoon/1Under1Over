...
export class CombatSystem {
  ...
  static get DROP_TABLES() {
    return {
      ...
      vineclaw:    [{ mat: 'fiber',          label: 'Fiber',           chance: 0.55 },
                    { mat: 'timber',         label: 'Timber',          chance: 0.30 }],
      sporeback:   [{ mat: 'carbon_biomass', label: 'Carbon Biomass',  chance: 0.50 },
      ...
      glacierback: [{ mat: 'armorPlate',     label: 'Armor Plate',     chance: 0.50 },
                    { mat: 'tungsten',       label: 'Tungsten',        chance: 0.30 }],
      blubberfin:  [{ mat: 'silver',         label: 'Silver',          chance: 0.35 },
                    { mat: 'titanium',       label: 'Titanium',        chance: 0.30 }],
      rimeburrow:  [{ mat: 'titanium',       label: 'Titanium',        chance: 0.45 },
                    { mat: 'quartz',         label: 'Quartz',          chance: 0.35 }],
      shardback:   [{ mat: 'armorPlate',     label: 'Armor Plate',     chance: 0.50 },
                    { mat: 'tungsten',       label: 'Tungsten',        chance: 0.35 }],
      cryolisk:    [{ mat: 'quartz',         label: 'Quartz',          chance: 0.45 },
                    { mat: 'silver',         label: 'Silver',          chance: 0.35 }],
      chillwing:   [{ mat: 'silver',         label: 'Silver',          chance: 0.45 },
                    { mat: 'ironSpike',      label: 'Iron Spike',      chance: 0.30 }],
      scalerunner: [{ mat: 'ferrous_ore',    label: 'Ferrous Ore',     chance: 0.50 },
                    { mat: 'silica',         label: 'Silica',          chance: 0.30 }],
      duneplate:   [{ mat: 'armorPlate',     label: 'Armor Plate',     chance: 0.45 },
      ...
      boss_hollow:  [{ mat: 'tungsten',    label: 'Tungsten',     chance: 1, qty: 4 },
                     { mat: 'armorPlate',  label: 'Armor Plate',  chance: 1, qty: 3 }],
